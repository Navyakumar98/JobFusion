  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-blue-950 text-white px-6 py-12 flex flex-col items-center">
        ...
        >
          <span className="font-semibold text-blue-300">JobFusion </span> is an AI-powered platform designed to simplify your job search and recruitment process. Whether you're a
